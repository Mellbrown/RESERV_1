...
public class CheckReserveListAdapter extends BaseAdapter{
    private Context context;
    private Callback mCallback;
    private List<CheckReservation> reserveList;

    public CheckReserveListAdapter(Context context, List<CheckReservation> reserveList,Callback callback) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
       ...
       // comInfo.setText(reserveList.get(i).getComInfo());
        ...
        reservationIcon.setImageResource(R.drawable.btn_cancel);
...
//        }
        ...
        reservationIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {


                if (mCallback != null) {
                    mCallback.onClickCancel(pos);
                }
